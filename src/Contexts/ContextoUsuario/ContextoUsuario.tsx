...
type TiposContextoUsuario = {   
    ...
    cadastrouAgora: boolean,
    setCadastrouAgora: Dispatch<SetStateAction<boolean>>
}
...
export const UsuarioProvider = ({children}: {children: React.ReactNode}) => {
    ...
    const [cadastrouAgora, setCadastrouAgora] = useState<boolean>(false)
